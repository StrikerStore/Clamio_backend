...
class Database {
  ...
  /**
   * Create clone_transactions table for tracking clone attempt state.
   * Enables retry/resume: on failure, the next attempt reads the stored
   * clone_order_id and picks up from where the previous attempt stopped.
   */
